...
DATABASES = {
    'default': {
        ...
        'HOST': 'orhan-django-rds.czr3kgpphzqv.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'orhan-blog-django' # please enter your s3 bucket name
